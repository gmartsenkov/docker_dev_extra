...
" a vim restart and :PlugInstall
  ...
  let g:dotspacevim_additional_plugins = ['morhetz/gruvbox', 'ekalinin/Dockerfile.vim', 'vim-airline/vim-airline', 'vim-airline/vim-airline-themes', 'kien/ctrlp.vim', 'fatih/vim-go']
